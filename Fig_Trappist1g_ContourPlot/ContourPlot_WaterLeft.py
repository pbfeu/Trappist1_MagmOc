...
fig.suptitle(''+str(Name_Planet)+': $M^{ini}_{H_2O} = $ '+str(M_ini)+' TO', fontsize=16, fontweight='bold')

ax1 = fig.add_subplot(221)
if (N_Planet==4):
    CS_1 = ax1.contour(Ecc, K40, TSol, [8, 12, 16], colors='k', linestyles=(':','--','-'))
    labels = ['8','12','16']
elif (N_Planet==5):
    CS_1 = ax1.contour(Ecc, K40, TSol, [6, 10, 14], colors='k', linestyles=(':','--','-'))
    labels = ['6', '10','14']
elif (N_Planet==6):
    CS_1 = ax1.contour(Ecc, K40, TSol, [6, 10, 14], colors='k', linestyles=(':','--','-'))
    labels = ['6', '10','14']
