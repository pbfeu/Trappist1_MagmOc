...
fig.suptitle('Solid: 100 TO water\nDashed: 100 TO water + 20 TO $\\mathrm{CO_2}$', fontsize=16)
...
ax7.plot([0,1], [0,1], label='atmosphere',   color=cmap(0))
ax7.plot([0,1], [0,1], label='magma ocean',   color=cmap(70))
ax7.plot([0,1], [0,1], label='solid',   color=cmap(220))
...
plt.savefig('Plot_TR1_e_comp_co2.png')
